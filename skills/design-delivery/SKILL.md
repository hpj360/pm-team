...
设计交付工具，帮助 UI 设计师生成设计规范文档、切图资源、标注文档与设计 Token，实现设计到开发的无缝交付。

> **职责边界说明**: 本 Skill 是设计交付环节的**唯一负责方**，承担原 `ui-design-toolkit` 委托的"切图导出"和"标注生成"能力。`ui-design-toolkit` 专注于设计阶段的设计系统生成与组件模板库，本 Skill 专注于交付阶段的规范化输出。两者形成"生产→交付"的清晰分工。
